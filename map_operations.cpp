...
{
	/*
	 * Associative container storing pairs <key, value> sorted by key, where the keys are unique. Sorting is done using a compare fucntion std::less, which can be changed via template arg
